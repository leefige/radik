#ifndef TOPK_ABLATION_BASELINE_H_
#define TOPK_ABLATION_BASELINE_H_
...
void topKRadixSelectL_baseline(
    ...
    // first iter
    // get hist
    radix_topk::countBinEx_naive<1024, 0, 20, PACKSIZE, WITHSCALE, LARGEST>
    ...
    radix_topk::selectCandidateEx_naive<256, 0, 20, PACKSIZE, WITHSCALE, LARGEST>
    ...
    radix_topk::filter_naive<LARGEST, 256, PACKSIZE, WITHSCALE, WITHIDXIN>
        <<<dim3(gridSizeX, gridSizeY), 256, 0, stream>>>(
...
#endif  // TOPK_ABLATION_BASELINE_H_
